...
const Wealth = () => {
    return ( 
        <div className="Wealth">
            ...
            <div>
            <h2>
             <i className="fas fa-square"></i> Create an Accout with Us
             </h2>
            ...
            <div>
            <h2>
             <i className="fas fa-square"></i> Set up your security
             </h2>
            ...
            <div>
            <h2>
             <i className="fas fa-square"></i> Add a payment Method
            </h2>
            ...
            <div>
            <h2>
             <i className="fas fa-square"></i> Monitor Your Earnings
             </h2>
